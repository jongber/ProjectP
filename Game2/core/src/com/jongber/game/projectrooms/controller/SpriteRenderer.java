...
import com.jongber.game.projectrooms.component.SpriteComponent;

import java.util.List;

public class SpriteRenderer extends Controller implements Controller.Renderer, Controller.GraphBuilder {
    ...
    public void build(List<GameObject> graph) {
        objs = this.buildSimple(graph, SpriteComponent.class);
    }
