package com.jongber.projectp.oldaction.game.detail;

import com.jongber.projectp.oldaction.common.JoinTraverser;
import com.jongber.projectp.oldaction.common.Traverser;
import com.jongber.projectp.oldaction.game.World;
import com.jongber.projectp.oldaction.game.detail.stage1.PlayerController;
import com.jongber.projectp.oldaction.game.detail.stage1.NPCController;
...
public class Stage1Logic implements World.WorldLogic, JoinTraverser<GameObject> {
    ...
    private com.jongber.projectp.oldaction.game.detail.stage1.NPCController NPCController;
